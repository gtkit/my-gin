// @Author xiaozhaofu 2023/2/23 15:54:00
package utils
...
func IPString2Long(ip string) (uint, error) {
	...
	if b == nil {
		return 0, goerr.Err("invalid ipv4 format")
	}
...
func Long2IPString(i uint) (string, error) {
	if i > math.MaxUint32 {
		return "", goerr.Err("beyond the scope of ipv4")
	}
...
func Long2IP(i uint) (net.IP, error) {
	if i > math.MaxUint32 {
		return nil, goerr.Err("beyond the scope of ipv4")
	}
